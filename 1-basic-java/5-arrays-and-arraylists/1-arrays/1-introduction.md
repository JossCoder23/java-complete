...
public class Main {
    public static void main(String[] args) {
        String[] robotArticles = {"Oil News", "Innovative Motors", "Organic Eye Implants", "Path Finding in an Unknown World"};
        int[] robotViewers = {87, 32, 11, 7};
        double[] robotRatings = {2.5, 3.2, 1.7, 4.3};
