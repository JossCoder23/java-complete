...
2. Inside ```main()``` of the Playlist.java file, create an array ```favoriteSongs``` that can hold ```String``` values and initialize it with your 10 favorite songs.
    ...
    **SOLUTION:**
    ...
    class Playlist {
        public static void main(String[] args) {
            ...
            String[] favoriteSongs = {"Queen - Bohemian Rhapsody","TOOL - Sober", "Stratovarius - Destiny", "Metallica - My friend of misery", "Megadeth - Hangar 18", "Oasis - Stand by me", "Paramore - Misery Bussines", "Linkin Park - Lost", "Belphegor - Totenkult", "Rammstein - Diamant"};
    ...
    **SOLUTION:**
    ...
    class Playlist {
        public static void main(String[] args) {
            ...
            ArrayList<String> desertIslandPlaylist = new ArrayList<String>();
            desertIslandPlaylist.add("Rammstein - Amerika");
            desertIslandPlaylist.add("Bullet for my Valentine - Your batrayal");
            desertIslandPlaylist.add("Slipknot - Get this");
            desertIslandPlaylist.add("Iron Maiden - Wasted Years");
            desertIslandPlaylist.add("Kreator - Hate uber alles");
...
8. Yikes! It turns out you can only bring five songs now. You’ll need to make some tough decisions and remove some of the songs from ```desertIslandPlaylist```.
...
10. The playlist seems a little boring. Let’s change the ```ArrayList``` by swapping some of the songs.
    ...
    **SOLUTION:**
    ...
    class Playlist {
        public static void main(String[] args) {
            ...
            int songA = desertIslandPlaylist.indexOf("Belphegor - Totenkult");
            int songB = desertIslandPlaylist.indexOf("Iron Maiden - Wasted Years");
    ...
    **SOLUTION:**
    ...
    class Playlist {
        public static void main(String[] args) {
            ...
            desertIslandPlaylist.set(songA, "Iron Maiden - Wasted Years");
    ...
    **SOLUTION:**
    ...
    class Playlist {
        public static void main(String[] args) {
            ...
            desertIslandPlaylist.remove("Paramore - Misery Bussines");
            desertIslandPlaylist.remove("Linkin Park - Lost");
            desertIslandPlaylist.remove("Rammstein - Diamant");
            desertIslandPlaylist.remove("TOOL - Sober");
...
15. Well done! You’ve successfully built your desert island playlist using arrays and ```ArrayList```s!
